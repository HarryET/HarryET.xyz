...
const BlogPost: NextPage<Params> = ({ contents, meta, view_count }) => {
    return (
            ...
            <div className={`px-12 pt-12 flex flex-col items-start space-y-12 text-gray-900 ${jb_mono.className}`}>
                ...
                <div className='w-full flex flex-row justify-between'>
                    ...
                    <div className='flex flex-col h-full justify-center gap-2 items-end'>
                        <p className='text-gray-500'>Published on {new Date(meta.date).toLocaleDateString()}</p>
                        <p className='text-gray-500'>{view_count} views</p>
                        <div className='text-gray-500 flex flex-row items-center gap-2 hover:underline hover:cursor-pointer' onClick={() => navigator.share({ url: window.location.href, title: meta.title })}>
                            Share
